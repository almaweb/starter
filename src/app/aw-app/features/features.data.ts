...
export const features: Feature[] = [
  {
    ...
    description: 'aw.features.angular',
  ...
  },
  {
    ...
    description: 'aw.features.angular-material',
  ...
  },
  {
    ...
    description: 'aw.features.angular-cli',
  ...
  },
  {
    ...
    description: 'aw.features.bootstrap',
  ...
  },
  {
    ...
    description: 'aw.features.typescript',
  ...
  },
  {
    ...
    description: 'aw.features.ngxtranslate',
  ...
  },
  {
    ...
    description: 'aw.features.fontawesome',
  ...
  },
  {
    ...
    description: 'aw.features.cypress',
    github: 'https://github.com/cypress-io/cypress',
    documentation: 'https://www.cypress.io/'
  },
  {
    name: 'aw.features.themes.title',
    description: 'aw.features.themes.description',
    documentation: 'https://material.angular.io/guide/theming',
    medium:
      'https://medium.com/@tomastrajan/the-complete-guide-to-angular-material-themes-4d165a9d24d1'
  },
  {
    name: 'aw.features.lazyloading.title',
    description: 'aw.features.lazyloading.description',
    documentation:
